			...
			<div class="nftmax-smenu">
				...
				<div class="admin-menu">
					...
					<div class="logout-button">
						<a class="nftmax-btn primary" href="" data-bs-toggle="modal" data-bs-target="#logout_modal"><div class="logo-button__icon"><img src="assets/img/logout.png" alt="#"></div><span class="menu-bar__name">Signout</span></a>
					</div>
				</div>
				<!-- End Admin Menu -->
			</div>
						...
						<div class="modal-body nftmax-modal__body modal-body nftmax-close__body">
							<div class="nftmax-preview__close">
								...
								<div class="nftmax__item-button--group">
									<a href="{{ url('/admin-logout') }}" class="nftmax__item-button--single nftmax-btn nftmax-btn__bordered bg radius " type="submit">Yes Logout 
									</a>																
