	...
	<div class="nftmax-wc__form">
		<div class="nftmax-wc__form-inner nftmax-wc__form-new">
			<div class="nftmax-wc__heading">
				<h3 class="nftmax-wc__form-title nftmax-wc__form-title__two"
					style="background-image:url('img/heading-vector-2.png')">Create Account</h3>
				<span>
					@if ($errors->any())
			...
			<!-- Sign in Form -->
			<form class="nftmax-wc__form-main" action="{{route('register.auth.post')}}" method="POST">
				@csrf
				@method("post")
				<div class="row">
					<div class="col-lg-6 col-md-6 col-12">
						<div class="form-group">
							...
							<div class="form-group__input">
								<span class="nftmax-wc__icon"><svg width="15" height="20" viewBox="0 0 15 20"
								...
								<input class="nftmax-wc__form-input" type="text" name="first_name" placeholder="Adomx"
									required >
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-12">
						<div class="form-group">
							...
							<div class="form-group__input">
								...
								<input class="nftmax-wc__form-input" type="text" name="last_name" placeholder="Healsx"
									required>
							</div>
						</div>
					</div>
					<div class="col-12">
						<div class="form-group">
							...
							<div class="form-group__input">
								<span class="nftmax-wc__icon"><svg class="inline" xmlns="http://www.w3.org/2000/svg"
								...
								<input class="nftmax-wc__form-input" type="email" name="email"
									placeholder="demo232@gmail.com" required>
							</div>
						</div>
					</div>
					<div class="col-12">
						<div class="form-group">
							...
							<div class="form-group__input">
								<span class="nftmax-wc__icon"><svg class="inline" width="18" height="21"
					...
					<div class="col-12">
						...
						<div class="form-group">
							<div class="nftmax-wc__bottom">
								<p class="nftmax-wc__text">Already have an aceount? <a
										href="{{url('/adminlogin')}}">Login</a></p>
							</div>
						</div>
					</div>
				</div>
