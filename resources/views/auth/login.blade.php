    ...
    <div class="col-xxl-6 col-lg-6 col-12">
        ...
        <div class="nftmax-wc__form">
            <div class="nftmax-wc__form-inner">
                ...
                <form class="nftmax-wc__form-main" action="{{ route('login.auth') }}" method="POST">
                    @csrf
					...
					<div class="form-group">
                        ...
                        <div class="form-group__input">
                            ...
                            <input class="nftmax-wc__form-input" type="email" name="email" placeholder="demo@gmail.com"
                                required>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="form-group__input">
                            ...
                            <input class="nftmax-wc__form-input" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;"
                                id="password-field" type="password" name="password" placeholder="" required>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="nftmax-wc__bottom">
                            <p class="nftmax-wc__text">Dont’t have an aceount ? <a href="#">Sign up
                                    free</a></p>
                        </div>
                    </div>
